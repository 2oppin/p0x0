...
import {rdf} from "../../../../src/p0x0res/source/sources/files/rdf";
import {p0x0rdfSourceRecord} from "../../../../src/p0x0res/source/sources/files/p0x0/p0x0rdfSourceRecord";
import {p0x0} from "../../../../src/p0x0/p0x0";
import {p0x0rdfSourceRecordStatement} from "../../../../src/p0x0res/source/sources/files/p0x0/ip0x0rdfSourceRecordStatement";

const testP0x0 = 'Thing';

describe('RDF converter check', () => {
    it('read (' + testP0x0 + '.rdf) read', async () => {
        let rdfReader = new rdf(__dirname);
